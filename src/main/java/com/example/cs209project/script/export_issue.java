...
//        for(String webTool:web){
        File file=new File("SWT_issue_open.txt");
        ...
        for(int j=0;j<10;j++){
            String url ="https://api.github.com/search/issues?q=SWT+language:java+state:open&per_page=100&page="+j;
            URL Url =new URL(url);
...
//                }
                ...
                t.put("body",(JSONNull.getInstance().equals(tt.get("body")))?"No content": tt.get("body"));
